...
namespace StartReactor.Features.UI
{
	public class GameUIController : ControllerBase
	{
		...
		{
			var totalSequences = _levelsProvider.CurrentLevel.Sequences.Count;
		...
		{
			var totalSequences = _levelsProvider.CurrentLevel.Sequences.Count;
			var currentSequenceIndex = _gameModel.CurrentSequenceIndex;
			var currentSequenceNumber = currentSequenceIndex + 1;
